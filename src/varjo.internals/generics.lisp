...
(defgeneric add-symbol-binding (var-name val env))
(defgeneric add-global-symbol-binding (var-name val))
...
(defgeneric get-global-form-binding (name env))
...
(defgeneric get-global-symbol-binding (symbol respect-scope-rules))
