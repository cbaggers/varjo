...
(defgeneric add-top-level-lisp-function-decl (name in-args uniforms code &optional valid-glsl-versions))
...
(defgeneric build-top-level-lisp-function-decl (func env base-env))
...
(defgeneric delete-top-level-lisp-function-decl (name in-args-types))
...
(defgeneric get-top-level-lisp-function-decl-by-name (name env))
...
(defgeneric used-top-level-lisp-function-decls (e))
