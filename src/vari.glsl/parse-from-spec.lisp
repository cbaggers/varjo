...
(defparameter *glsl-type->varjo-type*
  '(("atomic_uint" v-atomic-uint)
    ...
    ("isubpassInput" v-isubpass-input)
    ("isubpassInputMS" v-isubpass-input-ms)
    ("itexture1D" v-itexture-1d)
    ("itexture1DArray" v-itexture-1d-array)
    ("itexture2D" v-itexture-2d)
    ("itexture2DArray" v-itexture-2d-array)
    ("itexture2DMS" v-itexture-2d-ms)
    ("itexture2DRect" v-itexture-2d-rect)
    ("itexture3D" v-itexture-3d)
    ("itextureBuffer" v-itexture-buffer)
    ("itextureCube" v-itexture-cube)
    ("itextureCubeArray" v-itexture-cube-array)
    ("itextureRect" v-itexture-rect)
    ("ivec2" v-ivec2)
    ("ivec3" v-ivec3)
    ("ivec4" v-ivec4)
    ("mat2" v-mat2)
    ...
    ("subpassInput" v-subpass-input)
    ("subpassInputMS" v-subpass-input-ms)
    ("texture1D" v-texture-1d)
    ("texture1DArray" v-texture-1d-array)
    ("texture2D" v-texture-2d)
    ("texture2DArray" v-texture-2d-array)
    ("texture2DMS" v-texture-2d-ms)
    ("texture2DRect" v-texture-2d-rect)
    ("texture3D" v-texture-3d)
    ("textureBuffer" v-texture-buffer)
    ("textureCube" v-texture-cube)
    ("textureCubeArray" v-texture-cube-array)
    ("textureRect" v-texture-rect)
    ...
    ("usubpassInput" v-usubpass-input)
    ("usubpassInputMS" v-usubpass-input-ms)
    ("utexture1D" v-utexture-1d)
    ("utexture1DArray" v-utexture-1d-array)
    ("utexture2D" v-utexture-2d)
    ("utexture2DArray" v-utexture-2d-array)
    ("utexture2DMS" v-utexture-2d-ms)
    ("utexture2DRect" v-utexture-2d-rect)
    ("utexture3D" v-utexture-3d)
    ("utextureBuffer" v-utexture-buffer)
    ("utextureCube" v-utexture-cube)
    ("utextureCubeArray" v-utexture-cube-array)
    ("utextureRect" v-utexture-rect)
    ("uvec2" v-uvec2)
    ("uvec3" v-uvec3)
    ("uvec4" v-uvec4)
    ("vec2" v-vec2)
