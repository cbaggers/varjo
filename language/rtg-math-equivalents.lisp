...
(v-defun v2! (x) "dvec2(~a)" (v-double) v-dvec2)
(v-defun v2! (x y) "dvec2(~a, ~a)" (v-double v-double) v-dvec2)
(v-defun v2! (x) "ivec2(~a)" (v-int) v-ivec2)
(v-defun v2! (x y) "ivec2(~a, ~a)" (v-int v-int) v-ivec2)
(v-defun v2! (x) "uvec2(~a)" (v-uint) v-uvec2)
(v-defun v2! (x y) "uvec2(~a, ~a)" (v-uint v-uint) v-uvec2)
...
(v-defun v3! (x) "dvec3(~a)" (v-double) v-dvec3)
(v-defun v3! (x y) "dvec3(~a, ~a, 0.0lf)" (v-double v-double) v-dvec3)
(v-defun v3! (x y z) "dvec3(~a, ~a, ~a)" (v-double v-double v-double) v-dvec3)
(v-defun v3! (x) "ivec3(~a)" (v-int) v-ivec3)
(v-defun v3! (x y) "ivec3(~a, ~a, 0)" (v-int v-int) v-ivec3)
(v-defun v3! (x y z) "ivec3(~a, ~a, ~a)" (v-int v-int v-int) v-ivec3)
(v-defun v3! (x) "uvec3(~a)" (v-uint) v-uvec3)
(v-defun v3! (x y) "uvec3(~a, ~a, 0)" (v-uint v-uint) v-uvec3)
(v-defun v3! (x y z) "uvec3(~a, ~a, ~a)" (v-uint v-uint v-uint) v-uvec3)
...
;; (v-defun v4! (x) "dvec4(~a)" (v-double) v-dvec4)
;; (v-defun v4! (x y) "dvec4(~a, ~a, 0.0lf, 0.0lf)" (v-double v-double) v-dvec4)
;; (v-defun v4! (x y z) "dvec4(~a, ~a, ~a, 0.0lf)" (v-double v-double v-double) v-dvec4)
;; (v-defun v4! (x y z w) "dvec4(~a, ~a, ~a, ~a)" (v-double v-double v-double v-double) v-dvec4)
;; (v-defun v4! (x) "ivec4(~a)" (v-int) v-ivec4)
;; (v-defun v4! (x y) "ivec4(~a, ~a, 0, 0)" (v-int v-int) v-ivec4)
;; (v-defun v4! (x y z) "ivec4(~a, ~a, ~a, 0)" (v-int v-int v-int) v-ivec4)
;; (v-defun v4! (x y z w) "ivec4(~a, ~a, ~a, ~a)" (v-int v-int v-int v-int) v-ivec4)
;; (v-defun v4! (x) "uvec4(~a)" (v-uint) v-uvec4)
;; (v-defun v4! (x y) "uvec4(~a, ~a, 0, 0)" (v-uint v-uint) v-uvec4)
;; (v-defun v4! (x y z) "uvec4(~a, ~a, ~a, 0)" (v-uint v-uint v-uint) v-uvec4)
;; (v-defun v4! (x y z w) "uvec4(~a, ~a, ~a, ~a)" (v-uint v-uint v-uint v-uint) v-uvec4)
