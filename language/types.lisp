...
(def-v-type-class v-gsampler-1d (v-spec-type) ())
(def-v-type-class v-gsampler-2d (v-spec-type) ())
(def-v-type-class v-gsampler-3d (v-spec-type) ())
(def-v-type-class v-gsampler-cube (v-spec-type) ())
(def-v-type-class v-gsampler-rect (v-spec-type) ())
(def-v-type-class v-gsampler-2d-rect (v-spec-type) ())
(def-v-type-class v-gsampler-2d-ms (v-spec-type) ())
(def-v-type-class v-gsampler-buffer (v-spec-type) ())
...
(def-v-type-class v-isampler-1d (v-sampler v-gsampler-1d)
  ((core :initform T :reader core-typep)
...
(def-v-type-class v-isampler-1d-array (v-sampler v-gsampler-1d-array)
  ((core :initform T :reader core-typep)
   ...
   (element-type :initform 'V-IVEC4)))
(def-v-type-class v-isampler-2d (v-sampler v-gsampler-2d)
  ((core :initform T :reader core-typep)
...
(def-v-type-class v-isampler-2d-array (v-sampler v-gsampler-2d-array)
  ((core :initform T :reader core-typep)
   ...
   (element-type :initform 'V-IVEC4)))
(def-v-type-class v-isampler-2d-ms (v-sampler v-gsampler-2d-ms)
  ((core :initform T :reader core-typep)
...
(def-v-type-class v-isampler-2d-ms-array (v-sampler)
  ((core :initform T :reader core-typep)
   ...
   (element-type :initform 'V-IVEC4)))
(def-v-type-class v-isampler-2d-rect (v-sampler v-gsampler-2d-rect)
  ((core :initform T :reader core-typep)
   (glsl-string :initform "isampler2DRect" :reader v-glsl-string)
   (element-type :initform 'V-IVEC4)))
(def-v-type-class v-isampler-3d (v-sampler v-gsampler-3d)
  ((core :initform T :reader core-typep)
   (glsl-string :initform "isampler3D" :reader v-glsl-string)
   (element-type :initform 'V-IVEC4)))
(def-v-type-class v-isampler-buffer (v-sampler v-gsampler-buffer)
  ((core :initform T :reader core-typep)
   (glsl-string :initform "isamplerBuffer" :reader v-glsl-string)
   (element-type :initform 'V-IVEC4)))
(def-v-type-class v-isampler-cube (v-sampler v-gsampler-cube)
  ((core :initform T :reader core-typep)
...
(def-v-type-class v-isampler-cube-array (v-sampler v-gsampler-cube-array)
  ((core :initform T :reader core-typep)
   ...
   (element-type :initform 'V-IVEC4)))
(def-v-type-class v-sampler-1d (v-sampler v-gsampler-1d)
  ((core :initform T :reader core-typep)
...
(def-v-type-class v-sampler-1d-shadow (v-sampler v-gsampler-1d-shadow)
  ((core :initform T :reader core-typep)
   ...
   (element-type :initform 'V-VEC4)))
(def-v-type-class v-sampler-2d (v-sampler v-gsampler-2d)
  ((core :initform T :reader core-typep)
...
(def-v-type-class v-sampler-2d-array-shadow
  ...
  ((core :initform T :reader core-typep)
   (glsl-string :initform "sampler2DArrayShadow" :reader
                glsl-string)
   (element-type :initform 'V-VEC4)))
(def-v-type-class v-sampler-2d-ms (v-sampler v-gsampler-2d-ms)
  ((core :initform T :reader core-typep)
...
(def-v-type-class v-sampler-2d-ms-array (v-sampler v-gsampler-2d-ms-array)
  ((core :initform T :reader core-typep)
   ...
   (element-type :initform 'V-VEC4)))
(def-v-type-class v-sampler-2d-rect (v-sampler v-gsampler-2d-rect)
  ((core :initform T :reader core-typep)
...
(def-v-type-class v-sampler-2d-shadow (v-sampler v-gsampler-2d-shadow)
  ((core :initform T :reader core-typep)
   ...
   (element-type :initform 'V-VEC4)))
(def-v-type-class v-sampler-3d (v-sampler v-gsampler-3d)
  ((core :initform T :reader core-typep)
   (glsl-string :initform "sampler3D" :reader v-glsl-string)
   (element-type :initform 'V-VEC4)))
(def-v-type-class v-sampler-buffer (v-sampler v-gsampler-buffer)
  ((core :initform T :reader core-typep)
   (glsl-string :initform "samplerBuffer" :reader v-glsl-string)
   (element-type :initform 'V-VEC4)))
(def-v-type-class v-sampler-cube (v-sampler v-gsampler-cube)
  ((core :initform T :reader core-typep)
...
(def-v-type-class v-sampler-cube-shadow (v-sampler v-gsampler-cube-shadow)
  ((core :initform T :reader core-typep)
   ...
   (element-type :initform 'V-VEC4)))
(def-v-type-class v-usampler-1d (v-sampler v-gsampler-1d)
  ((core :initform T :reader core-typep)
...
(def-v-type-class v-usampler-1d-array (v-sampler v-gsampler-1d-array)
  ((core :initform T :reader core-typep)
   ...
   (element-type :initform 'V-UVEC4)))
(def-v-type-class v-usampler-2d (v-sampler v-gsampler-2d)
  ((core :initform T :reader core-typep)
...
(def-v-type-class v-usampler-2d-array (v-sampler v-gsampler-2d-array)
  ((core :initform T :reader core-typep)
   ...
   (element-type :initform 'V-UVEC4)))
(def-v-type-class v-usampler-2d-ms (v-sampler v-gsampler-2d-ms)
  ((core :initform T :reader core-typep)
...
(def-v-type-class v-usampler-2d-ms-array (v-sampler)
  ((core :initform T :reader core-typep)
   ...
   (element-type :initform 'V-UVEC4)))
(def-v-type-class v-usampler-2d-rect (v-sampler v-gsampler-2d-rect)
  ((core :initform T :reader core-typep)
   (glsl-string :initform "usampler2DRect" :reader v-glsl-string)
   (element-type :initform 'V-UVEC4)))
(def-v-type-class v-usampler-3d (v-sampler v-gsampler-3d)
  ((core :initform T :reader core-typep)
   (glsl-string :initform "usampler3D" :reader v-glsl-string)
   (element-type :initform 'V-UVEC4)))
(def-v-type-class v-usampler-buffer (v-sampler v-gsampler-buffer)
  ((core :initform T :reader core-typep)
   (glsl-string :initform "usamplerBuffer" :reader v-glsl-string)
   (element-type :initform 'V-UVEC4)))
(def-v-type-class v-usampler-cube (v-sampler v-gsampler-cube)
  ((core :initform T :reader core-typep)
...
(def-v-type-class v-usampler-cube-array (v-sampler v-gsampler-cube-array)
  ((core :initform T :reader core-typep)
   ...
   (element-type :initform 'V-UVEC4)))
(def-v-type-class v-sampler-rect (v-sampler v-gsampler-rect)
  ((core :initform T :reader core-typep)
   (glsl-string :initform "samplerRect" :reader v-glsl-string)
   (element-type :initform 'V-UVEC4)))
(def-v-type-class v-isampler-rect (v-sampler v-gsampler-rect)
  ((core :initform T :reader core-typep)
   (glsl-string :initform "isamplerRect" :reader v-glsl-string)
   (element-type :initform 'V-UVEC4)))
(def-v-type-class v-usampler-rect (v-sampler v-gsampler-rect)
  ((core :initform T :reader core-typep)
...
(def-v-type-class v-image-rect (v-t-type v-gimage-rect)
  ((core :initform t :reader core-typep)
   (glsl-string :initform "imageRect" :reader v-glsl-string)))

(def-v-type-class v-iimage-rect (v-t-type v-gimage-rect)
  ((core :initform t :reader core-typep)
   (glsl-string :initform "iimageRect" :reader v-glsl-string)))

(def-v-type-class v-uimage-rect (v-t-type v-gimage-rect)
  ((core :initform t :reader core-typep)
...
(def-v-type-class v-ibuffer-image (v-t-type v-gbuffer-image)
  ((core :initform t :reader core-typep)
   (glsl-string :initform "ibufferImage" :reader v-glsl-string)))
