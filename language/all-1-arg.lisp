(loop :for i :in a :collect
            (destructuring-bind (&key name in-args output-type transform context-restriction) i
              `(vdefun ,name ,(append (mapcar #'first in-args) 
                                      (when context-restriction 
                                        (cons '&context context-restriction)))
                       ,transform ,(mapcar #'second in-args) ,output-type)))
...
'((:name %void :in-args nil :output-type :void :transform "" :context-restriction nil)
  ...
  (:name uint :in-args ((x ((:bool :double :float :int :uint :uvec2 :uvec3 :uvec4)))) :output-type :uint :transform "uint(~a)" :context-restriction ((:330)))
  (:name degrees :in-args ((radians all-floats)) :output-type 0 :transform "degrees(~a)" :context-restriction ((:330)))
  (:name radians :in-args ((degrees all-floats)) :output-type 0 :transform "radians(~a)" :context-restriction ((:330)))
  (:name sin :in-args ((angle all-floats)) :output-type 0 :transform "sin(~a)" :context-restriction ((:330)))
  (:name cos :in-args ((angle all-floats)) :output-type 0 :transform "cos(~a)" :context-restriction ((:330)))
  (:name tan :in-args ((angle all-floats)) :output-type 0 :transform "tan(~a)" :context-restriction ((:330)))
  (:name asin :in-args ((x all-floats)) :output-type 0 :transform "asin(~a)" :context-restriction ((:330)))
  (:name acos :in-args ((x all-floats)) :output-type 0 :transform "acos(~a)" :context-restriction ((:330)))
  (:name atan :in-args ((y all-floats :compatible) (x all-floats :compatible)) :output-type 0 :transform "atan(~a, ~a)" :context-restriction ((:330)))
  (:name atan :in-args ((y-over-x all-floats)) :output-type 0 :transform "atan(~a)" :context-restriction ((:330)))
  (:name sinh :in-args ((angle all-floats)) :output-type 0 :transform "sinh(~a)" :context-restriction ((:330)))
  (:name cosh :in-args ((angle all-floats)) :output-type 0 :transform "cosh(~a)" :context-restriction ((:330)))
  (:name tanh :in-args ((angle all-floats)) :output-type 0 :transform "tanh(~a)" :context-restriction ((:330)))
  (:name asinh :in-args ((angle all-floats)) :output-type 0 :transform "asinh(~a)" :context-restriction ((:330)))
  (:name acosh :in-args ((angle all-floats)) :output-type 0 :transform "acosh(~a)" :context-restriction ((:330)))
  (:name atanh :in-args ((angle all-floats)) :output-type 0 :transform "atanh(~a)" :context-restriction ((:330)))
  (:name exp :in-args ((x all-floats)) :output-type 0 :transform "exp(~a)" :context-restriction ((:330)))
  (:name log :in-args ((x all-floats)) :output-type 0 :transform "log(~a)" :context-restriction ((:330)))
  (:name exp2 :in-args ((x all-floats)) :output-type 0 :transform "exp2(~a)" :context-restriction ((:330)))
  (:name log2 :in-args ((x all-floats)) :output-type 0 :transform "log2(~a)" :context-restriction ((:330)))
  (:name sqrt :in-args ((x all-floats)) :output-type 0 :transform "exp(~a)" :context-restriction ((:330)))
  (:name inversesqrt :in-args ((x all-floats)) :output-type 0 :transform "inversesqrt(~a)" :context-restriction ((:330)))
  (:name abs :in-args ((x all-floats-and-ints)) :output-type 0 :transform "abs(~a)" :context-restriction ((:330)))
  ...
  (:name fract :in-args ((x all-floats)) :output-type 0 :transform "fract(~a)" :context-restriction ((:330)))
  (:name is-nan :in-args ((x :float)) :output-type v-bool :transform "isnan(~a, ~a, ~a)" :context-restriction ((:330)))
  ...
  (:name normalize :in-args ((x all-floats)) :output-type 0 :transform "normalize(~a)" :context-restriction ((:330)))
  (:name transpose :in-args ((m v-square)) :output-type 0 :transform "transpose(~a)" :context-restriction ((:330)))
  (:name transpose :in-args ((m v-mat2x3)) :output-type v-mat3x2 :transform "transpose(~a)")
  (:name transpose :in-args ((m v-mat2x4)) :output-type v-mat4x2 :transform "transpose(~a)" :context-restriction ((:330)))
  (:name transpose :in-args ((m v-mat3x2)) :output-type v-mat2x3  :transform "transpose(~a)") 
  (:name transpose :in-args ((m v-mat3x4)) :output-type v-mat4x3 :transform "transpose(~a)" :context-restriction ((:330)))
  (:name transpose :in-args ((m v-mat4x3)) :output-type v-mat3x4  :transform "transpose(~a)")
  (:name transpose :in-args ((m v-mat4x2)) :output-type v-mat2x4  :transform "transpose(~a)" :context-restriction ((:330)))
  ...
  (:name -- :in-args ((x (float-and-int nil nil))) :output-type 0 :transform "(--~a)" :context-restriction ((:330)))
  (:name ! :in-args ((a v-bool)) :output-type v-bool :transform "(! ~a)" :context-restriction ((:330)))
  (:name ~ :in-args ((a ((:int :uint :ivec2 :ivec3 :ivec4)  nil))) :output-type 0 :transform "(~ ~a)" :context-restriction ((:330)))
