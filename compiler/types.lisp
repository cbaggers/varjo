...
(defmethod v-casts-to-p ((from-type v-type) (to-type symbol))
  (or (eq (v-type-name from-type) (v-type-name to-type))
...
(defclass all-floats-and-ints () ())
(defclass float-and-int () ())
(defclass all-floats (all-floats-and-ints) ())
(defclass all-ints (all-floats-and-ints) ())
...
(defclass v-int (v-number all-floats-and-ints float-and-int all-ints v-integer)
  ((core :initform t :reader core-typep)
   (glsl-string :initform "int" :reader v-glsl-string)
   (casts-to :initform '(v-uint v-float v-double))))
(defclass v-uint (v-number all-ints float-and-int v-integer)
  ((core :initform t :reader core-typep)
   (glsl-string :initform "uint" :reader v-glsl-string)
   (casts-to :initform '(v-float v-double))))
(defclass v-float (v-number all-floats float-and-int)
  ((core :initform t :reader core-typep)
...
(defclass v-mat2 (v-matrix v-square) 
  ((core :initform t :reader core-typep)
...
(defclass v-mat3 (v-matrix v-square)
  ((core :initform t :reader core-typep)
...
(defclass v-mat4 (v-matrix v-square)
  ((core :initform t :reader core-typep)
...
(defclass V-MAT2X2 (v-matrix v-square)
  ((core :initform T :reader core-typep)
...
(defclass V-MAT3X3 (v-matrix v-square)
  ((core :initform T :reader core-typep)
...
(defclass V-MAT4X4 (v-matrix v-square)
  ((core :initform T :reader core-typep)
...
(defclass v-bvec2 (v-bvector v-*vec2) 
  ((core :initform t :reader core-typep)
   (glsl-string :initform "bvec2" :reader v-glsl-string)
   (element-type :initform 'v-bool :reader v-element-type)
   (dimensions :initform '(2) :reader v-dimensions)))
(defclass v-bvec3 (v-bvector v-vec3-up v-*vec3)
  ((core :initform t :reader core-typep)
   (glsl-string :initform "bvec3" :reader v-glsl-string)
   (element-type :initform 'v-bool :reader v-element-type)
   (dimensions :initform '(3) :reader v-dimensions)))
(defclass v-bvec4 (v-bvector v-vec3-up v-vec4-up v-*vec4) 
  ((core :initform t :reader core-typep)
   (glsl-string :initform "bvec4" :reader v-glsl-string)
   (element-type :initform 'v-bool :reader v-element-type)
   (dimensions :initform '(4) :reader v-dimensions)))

(defclass v-uvector (v-vector all-ints) ())
(defclass v-uvec2 (v-uvector v-*vec2)
  ((core :initform t :reader core-typep)
...
(defclass v-uvec3 (v-uvector v-vec3-up v-*vec3)
  ((core :initform t :reader core-typep)
   (glsl-string :initform "uvec3" :reader v-glsl-string)
   (element-type :initform 'v-uint :reader v-element-type)
   (dimensions :initform '(3) :reader v-dimensions)
   (casts-to :initform '(v-dvec3 v-vec3))))
(defclass v-uvec4 (v-uvector v-vec3-up v-vec4-up v-*vec4) 
  ((core :initform t :reader core-typep)
...
(defclass v-ivector (v-vector all-ints) ())
(defclass v-ivec2 (v-ivector v-*vec2) 
  ((core :initform t :reader core-typep)
...
(defclass v-ivec3 (v-ivector v-vec3-up v-*vec3) 
  ((core :initform t :reader core-typep)
   (glsl-string :initform "ivec3" :reader v-glsl-string)
   (element-type :initform 'v-int :reader v-element-type)
   (dimensions :initform '(3) :reader v-dimensions)
   (casts-to :initform '(v-uvec3 v-vec3 v-dvec3))))
(defclass v-ivec4 (v-ivector v-vec3-up v-vec4-up v-*vec4) 
  ((core :initform t :reader core-typep)
